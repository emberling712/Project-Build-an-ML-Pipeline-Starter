...
def go(args):
    ...
    # Optional: handle "none" stratification, but config usually sets a real column
    stratify_col = None if args.stratify_by == "none" else X[args.stratify_by]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--rf_config",
        help=(
            "Random forest configuration. A JSON dict that will be passed to the "
